...
import cz.fi.muni.xkremser.editor.client.view.TabUtils.GetLayoutOperation;
...
public class ModsTab
    ...
    private class GetRelatedItem
         ...
         * (non-Javadoc)
         * @see
         * cz.fi.muni.xkremser.editor.client.view.TabUtils.GetLayoutOperation
         * #execute()
         */
     ...
     * 
     * @param maxDeep
     *        maximal number of recursion of MODS element
     */
    public ModsTab(int maxDeep) {
        this(maxDeep, null);
    }
     ...
     *        an existing MODS object to the tab fill with
     */
    ...
    private VLayout getModsLayout(boolean attributePresent,
        ...
        Tab[] lazyTabs =
                new Tab[] {
                        getTab(TabUtils.getTitleInfoStack(true, modsTypeClient_ == null ? null
                                : modsTypeClient_.getTitleInfo(), titleInfoHolders), "Title Info"), name,
                        type, genre, origin, language, physical, abstractt, toc, audience, note, subject,
                    ...
                    switch (event.getTab().getAttributeAsInt(TAB_TYPE)) {
                        ...
                        case MODS_NAME:
                            ...
                            timer = new Timer() {
                                ...
                                public void run() {
                                    Tab t =
                                            getTab(TabUtils.getNameStack(true, modsTypeClient_ == null ? null
                                                    : modsTypeClient_.getName(), nameHolders), "Name");
                        ...
                        case MODS_TYPE:
                            ...
                            timer = new Timer() {
                                ...
                                public void run() {
                                    Tab t =
                                            getTab(TabUtils.getTypeOfResourceStack(true,
                                                                                   modsTypeClient_ == null ? null
                                                                                           : modsTypeClient_
                                                                                                   .getTypeOfResource(),
                                                                                   typeOfResourceHolders),
                                                   "Type");
                                    TabSet ts = event.getTab().getTabSet();
                        ...
                        case MODS_GENRE:
                            ...
                            timer = new Timer() {
                                ...
                                public void run() {
                                    Tab t =
                                            getTab(TabUtils.getGenreStack(true,
                                                                          modsTypeClient_ == null ? null
                                                                                  : modsTypeClient_
                                                                                          .getGenre(),
                                                                          genreHolders), "Genre");
                        ...
                        case MODS_LANG:
                            ...
                            timer = new Timer() {
                                ...
                                public void run() {
                                    Tab t =
                                            getTab(TabUtils.getLanguageStack(true,
                                                                             modsTypeClient_ == null ? null
                                                                                     : modsTypeClient_
                                                                                             .getLanguage(),
                        ...
                        case MODS_ABSTRACT:
                            ...
                            timer = new Timer() {
                                ...
                                public void run() {
                                    Tab t =
                                            getTab(TabUtils.getAbstractStack(true,
                                                                             modsTypeClient_ == null ? null
                                                                                     : modsTypeClient_
                                                                                             .getAbstrac(),
                        ...
                        case MODS_PHYS:
                            ...
                            timer = new Timer() {
                                ...
                                public void run() {
                                    Tab t =
                                            getTab(TabUtils.getPhysicalDescriptionStack(true,
                                                                                        modsTypeClient_ == null ? null
                                                                                                : modsTypeClient_
                                                                                                        .getPhysicalDescription(),
                                                                                        physicalDescriptionHolders),
                                                   "Physical desc.");
                                    TabSet ts = event.getTab().getTabSet();
                        ...
                        case MODS_TOC:
                            ...
                            timer = new Timer() {
                                ...
                                public void run() {
                                    Tab t =
                                            getTab(TabUtils.getTableOfContentsStack(true,
                                                                                    modsTypeClient_ == null ? null
                                                                                            : modsTypeClient_
                                                                                                    .getTableOfContents(),
                                                                                    tableOfContentsHolders),
                                                   "Table of Con.");
                                    TabSet ts = event.getTab().getTabSet();
                        ...
                        case MODS_TARGET:
                            ...
                            timer = new Timer() {
                                ...
                                public void run() {
                                    Tab t =
                                            getTab(TabUtils.getTargetAudienceStack(true,
                                                                                   modsTypeClient_ == null ? null
                                                                                           : modsTypeClient_
                                                                                                   .getTargetAudience(),
                                                                                   audienceHolder),
                        ...
                        case MODS_NOTE:
                            ...
                            timer = new Timer() {
                                ...
                                public void run() {
                                    Tab t =
                                            getTab(TabUtils.getNoteStack(true, modsTypeClient_ == null ? null
                                                    : modsTypeClient_.getNote(), noteHolders), "Note");
                                    TabSet ts = event.getTab().getTabSet();
                        ...
                        case MODS_SUBJECT:
                            ...
                            timer = new Timer() {
                                ...
                                public void run() {
                                    Tab t =
                                            getTab(TabUtils.getSubjectStack(true,
                                                                            modsTypeClient_ == null ? null
                                                                                    : modsTypeClient_
                                                                                            .getSubject(),
                        ...
                        case MODS_CLASS:
                            ...
                            timer = new Timer() {
                                ...
                                public void run() {
                                    Tab t =
                                            getTab(TabUtils.getClassificationStack(true,
                                                                                   modsTypeClient_ == null ? null
                                                                                           : modsTypeClient_
                                                                                                   .getClassification(),
                            ...
                            timer = new Timer() {
                                ...
                                public void run() {
                                    ...
                                    if (deep > 0) {
                                        ...
                                        t =
                                                getTab(TabUtils.getSomeStack(true,
                                                                             "Related Item",
                                                                             getRelatedItem), "Related Item");
                                    } else {
                        ...
                        case MODS_LOCATION:
                            ...
                            timer = new Timer() {
                                ...
                                public void run() {
                                    Tab t =
                                            getTab(TabUtils.getLocationStack(true,
                                                                             modsTypeClient_ == null ? null
                                                                                     : modsTypeClient_
                                                                                             .getLocation(),
                        ...
                        case MODS_ACCESS:
                            ...
                            timer = new Timer() {
                                ...
                                public void run() {
                                    Tab t =
                                            getTab(TabUtils.getAccessConditionStack(true,
                                                                                    modsTypeClient_ == null ? null
                                                                                            : modsTypeClient_
                                                                                                    .getAccessCondition(),
                                                                                    accessConditionHolders),
                                                   "Access Condition");
                                    TabSet ts = event.getTab().getTabSet();
                        ...
                        case MODS_PART:
                            ...
                            timer = new Timer() {
                                ...
                                public void run() {
                                    Tab t =
                                            getTab(TabUtils.getPartStack(true, modsTypeClient_ == null ? null
                                                    : modsTypeClient_.getPart(), partHolders), "Part");
                                    TabSet ts = event.getTab().getTabSet();
            ...
            for (RelatedItemHolder item : relatedItemHolders) {
                ...
                if (item != null) {
                    if (item.getRelatedItemAttributeHolder().getAttributeForm() != null) {
                        ...
                        relatedItemTypeClient.setId(item.getRelatedItemAttributeHolder().getAttributeForm()
                                .getValueAsString(ModsConstants.ID));
                        relatedItemTypeClient.setType(item.getRelatedItemAttributeHolder().getAttributeForm()
                                .getValueAsString(ModsConstants.TYPE));
                        relatedItemTypeClient.setXlink(item.getRelatedItemAttributeHolder()
